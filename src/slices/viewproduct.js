...
import { StarIcon, PlusCircleIcon, MinusCircleIcon, ChevronUpIcon, PencilIcon } from '@heroicons/react/solid';
    ...
    return (
        <div>
            ...
            <main className="grid grid-cols-2 grid-rows-2 md:grid-cols-3 md:grid-rows-1 gap-x-5 p-5 max-w-screen-lg mx-auto mt-28">
                <div className="">
                    <Image className="rounded-md overflow-hidden" width={250} height={250} objectFit="contain" src="https://i.ibb.co/cy7h5R5/476ce1c4-3b37-4cf4-9ce6-b63584889140.jpg"/>
                </div>


                <div className="">
                    <div className="font-bold text-lg text-gray-700">
                        Realme C15 4/64 Quick Charge Abu abu
                    </div>
                    <div className="flex my-2">
                        <StarIcon className="h-5 w-5 text-yellow-400"/>
                        <p className="text-sm text-gray-400 ml-1">4.8 (800 ulasan)</p>
                    </div>
                    <div className="my-2 text-3xl font-bold text-gray-700">Rp1.799.000</div>
                ...
                <div className="mt-4 md:mt-0 col-span-2 md:col-span-1 flex justify-center">
                    <div className="w-11/12 flex flex-col border border-gray-300 rounded-md p-3">
                        ...
                        <div className="flex">
                            ...
                            <button className="py-2 rounded-md px-3 m-2 bg-tokped_green text-sm font-bold text-white">+ Keranjang</button>
                        </div>
